...
async def give_filter(client, message):
    ...
    if message.chat.id != SUPPORT_CHAT_ID:
        ...
        if total_results == 0:
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=f"https://t.me/unreal_verse")]]))
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         ...
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/unreal_verse")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url="https://t.me/unreal_verse")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    #-x
        ...
        buttons = [[
            InlineKeyboardButton('☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆', url=f'https://t.me/shubham_X_official')
        ],[
...
#-x
    ...
    #jisshu
        ...
        buttons = [[
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ •', url='https://t.me/unreal_X_bot')
        ],[
            InlineKeyboardButton('• ɢʀᴏᴜᴘ¹ •', url='https://t.me/unreal_verse'),
            InlineKeyboardButton('• ɢʀᴏᴜᴘ² •', url='https://t.me/unreal_verse_2')
        ],[
            InlineKeyboardButton('• ʀᴇǫᴜᴇꜱᴛ ɢʀᴏᴜᴘ •', url='https://t.me/unreal_Zonex')
        ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('• ᴜɴʀᴇᴀʟ ᴀᴅᴍɪɴ •', url='https://t.me/SHUBHAM_X_OFFICIAL')
        ],[
